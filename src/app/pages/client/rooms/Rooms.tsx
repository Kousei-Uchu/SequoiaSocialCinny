...
import { getExplorePath, getRoomsRoomPath, getRoomsSearchPath } from '../../pathUtils';
...
export function Rooms() {
  ...
  const searchSelected = useRoomsSearchSelected();
                  ...
                  return (
                    ...
                    >
                      <RoomNavItem
                        room={room}
                        selected={selected}
                        linkPath={getRoomsRoomPath(getCanonicalAliasOrRoomId(mx, roomId))}
