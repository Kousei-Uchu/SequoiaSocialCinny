...
export function RoomsTab() {
  ...
  const roomsUnread = useRoomsUnread(orphanRooms, roomToUnreadAtom);
  const roomsSelected = useRoomsSelected();
  ...
  return (
    <SidebarItem active={roomsSelected}>
      ...
      {roomsUnread && (
        <SidebarItemBadge hasCount={roomsUnread.total > 0}>
          <UnreadBadge highlight={roomsUnread.highlight > 0} count={roomsUnread.total} />
        </SidebarItemBadge>
      )}
      {menuAnchor && (
        <PopOut
