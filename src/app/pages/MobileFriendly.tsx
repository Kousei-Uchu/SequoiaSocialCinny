...
import { DIRECT_PATH, EXPLORE_PATH, ROOMS_PATH, HOME_PATH, INBOX_PATH, SPACE_PATH } from './paths';
...
export function MobileFriendlyClientNav({ children }: MobileFriendlyClientNavProps) {
  ...
  const roomsMatch = useMatch({ path: ROOMS_PATH, caseSensitive: true, end: true });

  if (
    screenSize === ScreenSize.Mobile &&
    !(homeMatch || directMatch || spaceMatch || exploreMatch || inboxMatch || roomsMatch)
  ) {
    return null;
  }
