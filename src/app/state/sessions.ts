...
const removeFallbackSession = () => {
  localStorage.removeItem('sequoiasocial_hs_base_url');
  localStorage.removeItem('sequoiasocial_user_id');
  localStorage.removeItem('sequoiasocial_device_id');
  localStorage.removeItem('sequoiasocial_access_token');
};
const getFallbackSession = (): Session | undefined => {
  const baseUrl = localStorage.getItem('sequoiasocial_hs_base_url');
  const userId = localStorage.getItem('sequoiasocial_user_id');
  const deviceId = localStorage.getItem('sequoiasocial_device_id');
  const accessToken = localStorage.getItem('sequoiasocial_access_token');
